  ...
  return (
    <div className="min-h-screen bg-page text-fg font-sans">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-edge/60">
          ...
          <div className="relative max-w-6xl mx-auto px-5 md:px-8 py-20 md:py-28">
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold text-warning-fg bg-orange-500/10 border border-orange-500/20 mb-6">
                <Flame className="w-3.5 h-3.5" />
                POS System
              </span>
              <h1 className="text-4xl md:text-6xl font-black tracking-tight text-fg leading-[1.1] mb-5">
                Run your company from one{' '}
                <span className="bg-gradient-to-r from-brand-from via-accent to-success-fg bg-clip-text text-transparent">
                  point of sale
                </span>
              </h1>
              <p className="text-fg-muted text-base md:text-lg leading-relaxed mb-8 max-w-xl">
              ...
              <div className="flex flex-wrap gap-3">
                {user ? (
                  ...
                  <>
                    ...
                    <Link
                      to="/login"
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-chip/80 border border-edge-strong text-fg font-semibold text-sm hover:bg-chip transition-colors"
                    >
                      Login
                    </Link>
                  </>
        ...
        <section className="max-w-6xl mx-auto px-5 md:px-8 py-16 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-surface border border-edge rounded-2xl p-6">
              <div className="p-3 w-fit rounded-xl bg-indigo-500/10 text-accent border border-indigo-500/20 mb-4">
                <Package className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-fg mb-2">Product Management</h3>
            ...
            <div className="bg-surface border border-edge rounded-2xl p-6">
              <div className="p-3 w-fit rounded-xl bg-emerald-500/10 text-success-fg border border-emerald-500/20 mb-4">
                <ReceiptText className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-fg mb-2">Fast Billing</h3>
              <p className="text-sm text-fg-muted leading-relaxed">
            ...
            <div className="bg-surface border border-edge rounded-2xl p-6">
              <div className="p-3 w-fit rounded-xl bg-amber-500/10 text-warning-fg border border-amber-500/20 mb-4">
                <BarChart3 className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-fg mb-2">Live Dashboard</h3>
              <p className="text-sm text-fg-muted leading-relaxed">
        ...
        <footer className="border-t border-edge/80 py-8 text-center text-xs text-fg-subtle">
          POS System
        </footer>
      </main>
    </div>
