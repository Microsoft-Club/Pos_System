    ...
    <div className="min-h-screen bg-[#0b0f19] text-slate-100 font-sans">
      ...
      <main className="flex items-center justify-center px-4 py-12 md:py-16">
        <form
          ...
          className="w-full max-w-md bg-[#0f1626] border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl space-y-5"
        >
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">Sign in to access your POS dashboard.</p>
          </div>
